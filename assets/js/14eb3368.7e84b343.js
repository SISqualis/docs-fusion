"use strict";
(self["webpackChunkfusion"] = self["webpackChunkfusion"] || []).push([[6969],{
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"cardContainer":"cardContainer_S8oU","cardTitle":"cardTitle_HoSo","cardDescription":"cardDescription_c27F","cardIcon":"cardIcon_whke"});
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(4848);
;// ./src/components/Icons/FolderIcon.js
function FolderIcon({size="1.2em",className="",color="currentColor"}){return/*#__PURE__*/(0,jsx_runtime.jsx)("svg",{xmlns:"http://www.w3.org/2000/svg",width:size,height:size,viewBox:"0 0 24 24",fill:"none",stroke:color,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:className,children:/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"})});}
;// ./src/components/Icons/DocumentIcon.js
function DocumentIcon({size="1.2em",className="",color="currentColor"}){return/*#__PURE__*/(0,jsx_runtime.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",width:size,height:size,viewBox:"0 0 24 24",fill:"none",stroke:color,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:className,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:"M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"}),/*#__PURE__*/(0,jsx_runtime.jsx)("polyline",{points:"13 2 13 9 20 9"})]});}
;// ./src/components/Icons/ExternalLinkIcon.js
function ExternalLinkIcon({size="1.2em",className="",color="currentColor"}){return/*#__PURE__*/(0,jsx_runtime.jsxs)("svg",{xmlns:"http://www.w3.org/2000/svg",width:size,height:size,viewBox:"0 0 24 24",fill:"none",stroke:color,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:className,children:[/*#__PURE__*/(0,jsx_runtime.jsx)("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),/*#__PURE__*/(0,jsx_runtime.jsx)("polyline",{points:"15 3 21 3 21 9"}),/*#__PURE__*/(0,jsx_runtime.jsx)("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]});}
;// ./src/theme/DocCard/index.tsx
// Importe os componentes de ícone do diretório components/Icons
function useCategoryItemsPlural(){const{selectMessage}=usePluralForm();return count=>selectMessage(count,(0,Translate/* translate */.T)({message:'1 item|{count} items',id:'theme.docs.DocCard.categoryDescription.plurals',description:'The default description for a category card in the generated index about how many items this category includes'},{count}));}function CardContainer({className,href,children}){return/*#__PURE__*/(0,jsx_runtime.jsx)(Link/* default */.A,{href:href,className:(0,clsx/* default */.A)('card padding--lg',styles_module.cardContainer,className),children:children});}function CardLayout({className,href,icon,title,description}){return/*#__PURE__*/(0,jsx_runtime.jsxs)(CardContainer,{href:href,className:className,children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Heading/* default */.A,{as:"h2",className:(0,clsx/* default */.A)('text--truncate',styles_module.cardTitle),title:title,children:[icon&&/*#__PURE__*/(0,jsx_runtime.jsx)("span",{className:styles_module.cardIcon,children:icon}),title]}),description&&/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:(0,clsx/* default */.A)('text--truncate',styles_module.cardDescription),title:description,children:description})]});}function CardCategory({item}){const href=(0,docsUtils/* findFirstSidebarItemLink */.Nr)(item);const categoryItemsPlural=useCategoryItemsPlural();if(!href){return null;}return/*#__PURE__*/(0,jsx_runtime.jsx)(CardLayout,{className:item.className,href:href,icon:/*#__PURE__*/(0,jsx_runtime.jsx)(FolderIcon,{})// Use o componente FolderIcon
,title:item.label,description:item.description??categoryItemsPlural(item.items.length)});}function CardLink({item}){const iconNode=(0,isInternalUrl/* default */.A)(item.href)?/*#__PURE__*/(0,jsx_runtime.jsx)(DocumentIcon,{})// Use o DocumentIcon para links internos
:/*#__PURE__*/(0,jsx_runtime.jsx)(ExternalLinkIcon,{})// Use o ExternalLinkIcon para links externos
;const doc=(0,docsUtils/* useDocById */.cC)(item.docId??undefined);return/*#__PURE__*/(0,jsx_runtime.jsx)(CardLayout,{className:item.className,href:item.href,icon:iconNode,title:item.label,description:item.description??doc?.description});}function DocCard({item}){switch(item.type){case'link':return/*#__PURE__*/(0,jsx_runtime.jsx)(CardLink,{item:item});case'category':return/*#__PURE__*/(0,jsx_runtime.jsx)(CardCategory,{item:item});default:throw new Error(`unknown item type ${JSON.stringify(item)}`);}}
